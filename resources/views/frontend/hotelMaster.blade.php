        ...
        <div class="modal-dialog  modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Urmee Guest House</h5>
                        ...
                        <div class="bd-example bd-example-tabs">
                            <nav class="col-md-12">
                                <div class="nav nav-tabs nav-tabbing-padding" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-item-rooms nav-link text-black active" id="nav-home-tab" data-bs-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"> Twin Room (3)</a>
                                    <a class="nav-item nav-item-rooms nav-link text-black" id="nav-profile-tab" data-bs-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Suite (3)</a>
                                    <a class="nav-item nav-item-rooms nav-link text-black" id="nav-contact-tab" data-bs-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Queen Room (3)</a>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                    <div class="slider">
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/3.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/3a.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>

                                        <div>
                                            <img src="{{ asset('frontend')}}/images/hotel/urmee/3b.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    <div class="slider">
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/4.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/4a.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/4b.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                    <div class="slider">
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/5a.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/5.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>

                                        <div>
                                            <img  src="{{ asset('frontend')}}/images/hotel/urmee/5b.jpg" class="img-fluid hotel-rom-gal" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
