...
<head>
    ...
    <title>Reset Password - EZBOOKING</title>
</head>
<style>
...
<div class="wrapper">
    ...
    <div class="form-container">
        <div class="form-inner">
            ...
            <form action="{{ route('vendor-admin.password.update') }}" method="POST" class="login">
                @csrf
                ...
                <div class="pass-link">
                    <a href="{{ route('vendor-admin.login') }}">Back to Login</a>
                </div>
            </form>
        </div>
    </div>
