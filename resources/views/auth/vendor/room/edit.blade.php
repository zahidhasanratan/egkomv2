                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                @endphp
                                                                <input type="text" class="form-control" id="availability_dates" name="availability_dates" value="{{ $datesJson }}" placeholder="Click to open calendar and select dates" readonly style="margin-bottom: 15px; cursor: pointer;">
