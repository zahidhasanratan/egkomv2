    ...
    <div class="nk-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group d-flex align-items-center justify-content-between" style="padding: 12px; background: white; border-radius: 6px; border: 1px solid #dee2e6;">
                                                    ...
                                                    <div class="form-check form-switch" style="margin-left: 15px;">
                                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="is_active" style="width: 50px; height: 26px; cursor: pointer;" {{ old('is_active') ? 'checked' : '' }}>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group d-flex align-items-center justify-content-between" style="padding: 12px; background: white; border-radius: 6px; border: 1px solid #dee2e6;">
                                                    ...
                                                    <div class="form-check form-switch" style="margin-left: 15px;">
                                                        <input class="form-check-input" type="checkbox" id="coupleFriendlySwitch" name="couple_friendly" value="1" style="width: 50px; height: 26px; cursor: pointer;" {{ old('couple_friendly') ? 'checked' : '' }}>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card" style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px; background: #f8f9fa;">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Room Name" required style="border: 1px solid #dee2e6; border-radius: 6px;">
                                                            @error('name')
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control" name="room_number" value="{{ old('room_number') }}" placeholder="Room number" style="border: 1px solid #dee2e6; border-radius: 6px;">
                                                                    @error('room_number')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control" name="floor_number" value="{{ old('floor_number') }}" placeholder="Room Floor Number" style="border: 1px solid #dee2e6; border-radius: 6px;">
                                                                    @error('floor_number')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="number" class="form-control" name="size" value="{{ old('size') }}" placeholder="Ex: 1200 SFT" style="border: 1px solid #dee2e6; border-radius: 6px;">
                                                                    @error('size')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control" name="wifi_details" value="{{ old('wifi_details') }}" placeholder="WiFi Details/Password" style="border: 1px solid #dee2e6; border-radius: 6px;">
                                                                    @error('wifi_details')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                const existingBathrooms = [];
                // Ensure container exists before rendering
                if (bathroomDetailsContainer) {
                    renderBathroomSections(bathroomCount, existingBathrooms);
                } else {
                    console.error('bathroomDetailsContainer not found');
                }
