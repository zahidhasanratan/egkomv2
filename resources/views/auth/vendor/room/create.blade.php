                                        ...
                                        <div class="tab-pane active" id="tabItem3">
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="number" value="{{ old('number') }}" placeholder="Room number" required>
                                                        @error('number')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row mt-15">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="cancellation_policy[]" id="flexiblePolicy" value="flexible" {{ in_array('flexible', old('cancellation_policy', [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="cancellation_policy[]" id="nonRefundablePolicy" value="non_refundable" {{ in_array('non_refundable', old('cancellation_policy', [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="cancellation_policy[]" id="partiallyRefundablePolicy" value="partially_refundable" {{ in_array('partially_refundable', old('cancellation_policy', [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" name="cancellation_policy[]" id="longTermPolicy" value="long_term" {{ in_array('long_term', old('cancellation_policy', [])) ? 'checked' : '' }}>
