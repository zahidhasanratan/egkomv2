                            ...
                            <div class="card-aside-wrap">
                                <div class="card-inner card-inner-lg">
                                    ...
                                    <div class="nk-block">
                                        ...
                                        <form action="{{ route('vendor-admin.update.settings') }}" method="POST" enctype="multipart/form-data" class="gy-3 form-settings">
                                            @csrf
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="site-name" name="hotel_name" value="{{ old('hotel_name', $vendorSetting->hotel_name ?? '') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <label class="form-label" for="site-address">Contact Person Name</label>
                                                        <span class="form-note">Specify the Person Name.</span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="site-address" name="hotel_address" value="{{ old('contact_person_name', $vendorSetting->contact_person_name ?? '') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="email" class="form-control" id="site-email" name="email" value="{{ old('email', $vendorSetting->email ?? '') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3 align-center">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="form-control" id="site-phone" name="phone" value="{{ old('phone', $vendorSetting->phone ?? '') }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
