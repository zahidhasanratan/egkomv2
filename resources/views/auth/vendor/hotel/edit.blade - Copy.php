                                                            ...
                                                            @if(!empty($hotel->custom_nearby_area_details) && is_array($hotel->custom_nearby_area_details))
                                                                @for($i = 0; $i < count($hotel->custom_nearby_area_details); $i += 2)
                                                                    <div class="col-md-6 col-lg-6 col-xxl-6 mb-3">
                                                                        @php
                                                                            $category = isset($sectionLabelsMap[$hotel->nearby_area_category]) ? $hotel->nearby_area_category : 'restaurant';
                                                                        @endphp
                                                                        <div class="form-group">
                                                                            <label>{{ $sectionLabelsMap[$category][0] }}</label>
                                                                            <input type="text" class="form-control" name="custom_nearby_area_details[]" value="{{ $hotel->custom_nearby_area_details[$i] ?? '' }}" placeholder="Enter {{ $sectionLabelsMap[$category][0] }}" required>
                                                                        </div>
                                                                        <div class="form-group mt-2">
                                                                            <label>{{ $sectionLabelsMap[$category][1] }}</label>
                                                                            <input type="text" class="form-control" name="custom_nearby_area_details[]" value="{{ $hotel->custom_nearby_area_details[$i + 1] ?? '' }}" placeholder="Enter {{ $sectionLabelsMap[$category][1] }}" required>
                                                                        </div>
