...
`;
    ...
    <script>
        ...
        /** Ensure single "Add More +" button exists for a category and stays last */
      ...
      `;
                ...
                // Click adds another field to THIS category
            ...
            // Keep button as last element
            if (row.lastElementChild !== addBtnCol) {
                row.appendChild(addBtnCol);
            }
    ...
    `;
            ...
            // Insert BEFORE the add button so the button remains last
            ...
            newFieldGroup.querySelector('.delete-hotel-btn').addEventListener('click', function () {
                ...
                if (remainingFields === 0) {
                    // Remove entire category block (including button)
        ...
        // Dropdown selection → set current category + create first field
        ...
        // Global Add button (optional): adds to currently selected category
        ...
        (Array.isArray(hotelFacilitiesData) ? hotelFacilitiesData : []).forEach(facility => {
            ...
            const category = hotelFacilitiesCategoryKeysMap[categoryKey]; // readable category
