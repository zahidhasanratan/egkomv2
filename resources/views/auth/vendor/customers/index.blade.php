                            ...
                            <div class="drodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <ul class="link-list-opt no-bdr">
                                        <li><a href="{{ route('vendor.customers.export.excel') }}" target="_blank" rel="noopener"><em class="icon ni ni-file-docs"></em><span>Download Excel (CSV)</span></a></li>
                                        <li><a href="{{ route('vendor.customers.export.csv') }}" target="_blank" rel="noopener"><em class="icon ni ni-download"></em><span>Download CSV</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('vendor.bookings.index') }}?search={{ urlencode($customer->guest_email) }}" class="btn btn-sm btn-outline-primary" title="View bookings">View Bookings</a>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
