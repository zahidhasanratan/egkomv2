                                                    ...
                                                    <div class="row gy-4">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                @endphp
                                                                <input type="text" class="form-control" id="availability_dates" name="availability_dates" value="{{ old('availability_dates', $existingDatesJson) }}" placeholder="Click to open calendar and select dates" readonly style="margin-bottom: 15px; cursor: pointer;">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (availabilityInput) {
                    // Get existing dates from room data or old input
                    let existingDates = [];
