                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xxl-3">
                                            <div class="form-group">
                                                ...
                                                <select name="property_type" class="form-control">
                                                    <option {{ $vendor->property_type == '5 Star' ? 'selected' : '' }}>5 Star</option>
                                                    <option {{ $vendor->property_type == '3 Star' ? 'selected' : '' }}>3 Star</option>
                                                    <option {{ $vendor->property_type == '7 Star' ? 'selected' : '' }}>7 Star</option>
                                                    <option {{ $vendor->property_type == 'Star' ? 'selected' : '' }}>Star</option>
                                                    <option {{ $vendor->property_type == 'Boutique' ? 'selected' : '' }}>Boutique</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4 col-xxl-3">
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xxl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="address_district" name="address_district" value="{{ old('address_district', $vendor->address_district) }}">
                                            </div>
                                        </div>
