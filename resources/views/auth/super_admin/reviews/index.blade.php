                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        <li class="nk-block-tools-opt">
                                            <form method="GET" action="{{ route('super-admin.reviews.index') }}" class="d-flex align-items-center gap-2">
                ...
                <div class="nk-block">
                    <div class="card card-bordered card-stretch">
                        <div class="card-inner-group" style="padding: 10px;">
                            <form id="bulkActionForm" method="POST" action="{{ route('super-admin.reviews.bulk-approve') }}">
                                @csrf
                                                                ...
                                                                <div class="drodown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt no-bdr">
                                                                            <li>
                                                                                <a href="{{ route('super-admin.reviews.show', $review->id) }}">
                                                                            ...
                                                                            @endif
                                                                            <li>
                                                                                <form method="POST" action="{{ route('super-admin.reviews.toggle-featured', $review->id) }}" class="d-inline">
                                                                                    @csrf
                                                                                    <a href="#" onclick="event.preventDefault(); this.closest('form').submit();">
                                                                                        <em class="icon ni ni-star{{ $review->is_featured ? '-fill' : '' }}"></em>
                                                                            ...
                                                                            <li class="divider"></li>
                                                                            <li>
                                                                                <form method="POST" action="{{ route('super-admin.reviews.reject', $review->id) }}" class="d-inline" onsubmit="return confirm('Are you sure you want to reject and delete this review?');">
                                                                                    @csrf
                                                                                    <a href="#" onclick="event.preventDefault(); if(confirm('Are you sure you want to reject and delete this review?')) { this.closest('form').submit(); }" class="text-danger">
                                                                                        <em class="icon ni ni-trash"></em><span>Reject & Delete</span>
                                                                                    </a>
                                                                                </form>
                                                                            </li>
                                                                        </ul>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" onclick="bulkReject()">
                                                <em class="icon ni ni-trash"></em> Reject Selected
                                            </button>
                                        </div>
...
<script>
    ...
    function bulkApprove() {
        ...
        if (confirm(`Approve ${checked.length} review(s)?`)) {
            form.action = '{{ route("super-admin.reviews.bulk-approve") }}';
            form.method = 'POST';
            form.submit();
        }
    }
    ...
    function bulkReject() {
        ...
        if (confirm(`Reject and delete ${checked.length} review(s)? This action cannot be undone.`)) {
            form.action = '{{ route("super-admin.reviews.bulk-reject") }}';
            form.method = 'POST';
            form.submit();
        }
    }
