                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('super-admin.bookings.update', $booking->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @error('paid_amount')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <small class="form-text text-muted">Leave 0 if unpaid. Grand total: BDT {{ number_format($booking->grand_total, 2) }}</small>
                                                </div>
                                            </div>
                                        </div>
