                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $resetUrl }}" style="display: inline-block; padding: 14px 30px; background: linear-gradient(90deg, #9333EA 0%, #6B46C1 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">Reset Password</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="color: #6B46C1; font-size: 14px; word-break: break-all; margin-bottom: 20px;">
                                {{ $resetUrl }}
                            </p>
