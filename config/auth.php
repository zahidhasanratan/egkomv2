...
return [
    ...
    */
    ...
    'guards' => [
        ...
        'super-admin' => [ // Correct placement for the super-admin guard
            'driver' => 'session',
    ...
    */
    ...
    'providers' => [
        ...
        'super_admins' => [
            'driver' => 'eloquent',
            'model' => App\Models\SuperAdmin::class, // Adjust the model path if needed
        ],
    ...
    */
    ...
    'passwords' => [
        ...
        'vendors' => [  // Add password reset configuration for vendors
            'provider' => 'vendors',
            'table' => 'password_resets',
            'expire' => 60,
            'throttle' => 60,
